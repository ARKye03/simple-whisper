...
<script lang="ts">
  let { name, size = 20, class: cls = "" }: IconProps & { name: string } = $props();
...
{#if name === "upload"}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width={stroke} stroke-linecap="round" stroke-linejoin="round" class={cls}>
    <path d="M12 16V3m0 0l4 4m-4-4L8 7" />
    <path d="M3 17l.62 2.49A2 2 0 005.56 21h12.88a2 2 0 001.94-1.52L21 17" />
  </svg>
{:else if name === "film"}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width={stroke} stroke-linecap="round" stroke-linejoin="round" class={cls}>
...
{:else if name === "waveform"}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width={stroke} stroke-linecap="round" stroke-linejoin="round" class={cls}>
    <path d="M3 12h1M6 8v8M10 4v16M14 9v6M18 6v12M22 10v4" />
  </svg>
{:else if name === "spinner"}
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class={cls} style="animation: spin 1s linear infinite;">
